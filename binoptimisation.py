...
def draw_ROC(var ='dipho_dijet_MVA', label='VBF', title = 'variable', bkg = [], select='', categories=[]):
    ...
    # === define the stack
    hbkg = ROOT.TH1F('hbkg','',200,-1,1)
    hsig = ROOT.TH1F('hsig','',200,-1,1)
...
#---------------------------------------------------------------
def GetBondaryBin(var ='dipho_dijet_MVA', label='VBF', select='', fom='', xmin=-1, xmax=1,catidx=0):
    histos = []
    histfilename = ('plots/histogram_stack_'  +
                    var + '_' + label + '_'
                    + selection['name'])
...
if __name__ == "__main__":
    ...
    read_plotcard('config/vbf_plotcard_allbkg.json')
    ...
    dijet_roc_ggf = draw_ROC(var   = 'dijet_mva'     ,
                             label = 'dijetVBFMVA_ggf' ,
                             bkg   = ['gamgamjetbox','gamJet','dy_toll_m50','qcd'], categories=[0.92,0.64])
    ...
    #dijet_roc_ggf = draw_ROC(var   = 'dijet_mva'     ,
    #                         label = 'dijetVBFMVA_ggf' , 
    #                         bkg   = ['gamgamjetbox','gamJet','dy_toll_m50','qcd'])
    ##combi_roc_ggf = draw_ROC(var   = 'dipho_dijet_MVA'   ,
    ##                         label = 'dijetVBFMVA_ggf' ,
    #                         
    ...
    #gmul.SetTitle(';#varepsilon_{SM-Bakground};#varepsilon_{VBF}')
    #gmul.Draw('AL')
